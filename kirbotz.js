...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 × ${prefix}sellemas
 × ${prefix}selldiamond`
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: thumbrpg }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
「 PROFILE 」
 ...
 • Xp :  ${getLevelingXp(sender)}/${reqXp}
「 RPG GAME 」`
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgjoinrpg }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
addDm(sender, d)
        ...
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgslime }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imggoblin }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdevil }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgbehemoth }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemon }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemonking }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.sendMessage(from, { caption: teks, location: { jpegThumbnail: thumb }, templateButtons: button, footer: `👑 Owner  : ${owner.length}`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
.on('exit', () => {
kirbotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/BUKU/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
})
}
break
case 'nuliskanan':{
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                kirbotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/BUKU/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
                break
case 'foliokiri':{
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                kirbotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/FOLIO/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
                break
case 'foliokanan':{
...
replyNya(mess.wait)
                ...
                .on('exit', () => {
                kirbotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/FOLIO/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
                break
case 'mlstalk': {
...
kirbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Rpg Game By KennBot MD ", sectionnya, { quoted: fakekirbotz})
break
case 'slime':
case 'killslime':
...
kirbotz.send5ButImg(i, junn, `KennBot MD`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
kirbotz.send5Vid(i, junn, `KennBot MD`, buffer, butoon)
...
var button = [
        ...
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n • Tempat  ${ad}\n • MONEY : $${money}\n • EXP : ${adven}Xp`
        kirbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `Rpg Game By KennBot MD`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
...
kirbotz.sendMessage(from, { audio: { url: res.nowm }, mimetype: 'audio/mp4', ptt:true, contextInfo:{externalAdReply:{
title: `Hai Kak ${pushname}`,
body: `KennBot MD`,
thumbnail: ppnyauser,
mediaType:2,
...
`
try {
pp = await kirbotz.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
kirbotz.sendFile(m.chat, pp, "", m, { caption: tekse, mentions: await kirbotz.parseMention(tekse) })
})
}
case 'randomnama':
